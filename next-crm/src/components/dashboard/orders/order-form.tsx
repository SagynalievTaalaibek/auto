...
import { selectMastersCRM, selectUsersCRM } from '@/features/auth/authSlice';
import { fetchMastersCRM, fetchUsersCRM } from '@/features/auth/authThunks';
import { selectOneOrderUpdate } from '@/features/order/order.slice';
import { selectMainServices } from '@/features/service/service.slice';
...
export function OrderForm({ orderId }: Props) {
	...
	const handleSubmit = async () => {
		...
		if (!isEditMode) {
			console.log('Success CREATE', result.data);
		} else {
			console.log('Success EDIT', result.data);
		}
